...
public abstract class AbstractClusterEndpointTest extends TestCase {
    ...
    protected ClusterEndpoint createCluster(NMR nmr, String name, Transacted transacted, boolean rollbackOnErrors) throws Exception {
        ClusterEndpoint cluster = new ClusterEndpoint();
    ...
    protected ProxyEndpoint createProxy(NMR nmr, ClusterEndpoint cluster) throws Exception {
...
//            }
            synchronized (exchanges) {
                ...
                //System.err.println("Exchanges received: " + exchanges.size());
                exchanges.notifyAll();
            }
        ...
        public void assertExchangesReceived(int count, long timeout) {
            synchronized (exchanges) {
                ...
                assertTrue("expected number of messages when received: ", count <= exchanges.size());
            }
        }
    }
