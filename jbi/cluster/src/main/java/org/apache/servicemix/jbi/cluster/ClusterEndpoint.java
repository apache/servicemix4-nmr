 ...
 *
 * TODO: activemq specific implementation using org.apache.activemq.MessageAvailableListener
 *
 */
public class ClusterEndpoint extends ServiceRegistryImpl<ClusterRegistration>
    ...
    protected static final Log logger = LogFactory.getLog(ClusterEndpoint.class);
        ...
        if (exchange.getStatus() == Status.Active) {
            ...
            if (expectResponse) {
                ...
                if (requestor.getMessage() != null) {
                    message.setStringProperty(ClusterEndpoint.PROPERTY_CLUSTER_NAME, requestor.getMessage().getStringProperty(ClusterEndpoint.PROPERTY_SENDER_CLUSTER_NAME));
                    message.setStringProperty(ClusterEndpoint.PROPERTY_CORR_ID, requestor.getMessage().getStringProperty(ClusterEndpoint.PROPERTY_SENDER_CORR_ID));
                }
